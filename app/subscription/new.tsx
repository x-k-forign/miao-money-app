...
export default function NewSubscriptionScreen() {
  ...
  useEffect(() => {
    ...
    Promise.all([getCategories("expense"), getCategories("income")])
      ...
      .catch((error) => {
        console.warn("Load subscription categories failed", error);
      });
  ...
  async function save() {
    ...
    try {
      ...
      console.warn("Save subscription failed", error);
      setSaving(false);
    }
  }
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          <Animated.View entering={FadeInUp.delay(40).duration(260)}>
            <MiaoCard style={styles.card}>
              ...
              <TextField label="名称" value={name} onChangeText={setName} placeholder="例如：房租、工资、会员" />
