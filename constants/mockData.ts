...
export const mockExpenseCategories: MockCategory[] = [
  ...
  { id: "sport", name: "运动", kind: "expense", icon: "dumbbell", color: "#FFE8A9" },
  { id: "entertainment", name: "娱乐", kind: "expense", icon: "ticket", color: "#C9B7FF" },
  { id: "communication", name: "通讯", kind: "expense", icon: "phone", color: "#9ED9FF" },
  { id: "housing", name: "住房", kind: "expense", icon: "home", color: "#FFE8A9" },
  { id: "child", name: "孩子", kind: "expense", icon: "baby", color: "#FFC7A8" },
  ...
  { id: "study", name: "学习", kind: "expense", icon: "book", color: "#C9B7FF" },
  { id: "pet", name: "宠物", kind: "expense", icon: "paw", color: "#BDEDD8" },
  { id: "gift", name: "礼金", kind: "expense", icon: "gift", color: "#FFE8A9" },
  { id: "repair", name: "维修", kind: "expense", icon: "wrench", color: "#9ED9FF" },
  { id: "express", name: "快递", kind: "expense", icon: "package", color: "#FFC7A8" },
  { id: "movie", name: "电影", kind: "expense", icon: "film", color: "#C9B7FF" },
  { id: "daily", name: "日用品", kind: "expense", icon: "sparkles", color: "#9ED9FF" },
  { id: "cosmetics", name: "化妆品", kind: "expense", icon: "palette", color: "#FFB8D2" },
